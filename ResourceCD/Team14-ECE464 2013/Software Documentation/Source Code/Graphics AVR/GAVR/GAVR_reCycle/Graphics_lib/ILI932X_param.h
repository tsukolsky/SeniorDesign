// Some macros for commands/regs for ILI9325 controller
#ifndef ILI932X_param_H
#define ILI932X_param_H

// LCD controller chip identifiers (the only 2 we should need)
#define ID_932X    0
#define ID_UNKNOWN 0xFF

// Register names from Peter Barrett's Microtouch code
// Not including for all chips; unnecessary overhead for ReCycle
// (Reducing flexibility to save memory, since this will only be used
