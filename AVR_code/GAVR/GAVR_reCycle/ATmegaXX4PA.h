...
#define prtDEBUGleds	PORTC
#define ddrDEBUGleds	DDRC
#define pinDEBUGleds	PINC
#define bnWAVRCOMMled	1
#define bnBONECOMMled	2
#define bnSTARTINGled	3
#define bnUSERDATEled	4
#define bnUSERTIMEled	5

#define prtSTATUSled2		PORTD	//on led
#define ddrSTATUSled2		DDRD
#define pinSTATUSled2		PIND
#define bnSTATUSled2		7

#define prtSTATUSled	PORTC	//clock toggle LED
#define ddrSTATUSled	DDRC
#define pinSTATUSled	PINC
#define bnSTATUSled		0
